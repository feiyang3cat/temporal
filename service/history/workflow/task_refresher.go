...
// TimeSkippingDetail still flagged TaskRegenStatusNone on this cluster.
// Idempotent via the detail's TaskRegenStatus, so this pass is a no-op on
// workflows whose details are already marked Regenerated locally.
