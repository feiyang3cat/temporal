...
func (e *historyEngineImpl) SubscribeTimeSkippingFastForwardUpdate(executionKey chasm.ExecutionKey) (<-chan *commonpb.TimeSkippingInfo, func()) {
	return e.timeSkippingFastForwardNotifier.Subscribe(executionKey)
}
