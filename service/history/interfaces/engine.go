...
type (
	...
	Engine interface {
		...
		GetWorkflowTimeSkipping(ctx context.Context, request *historyservice.GetWorkflowTimeSkippingRequest) (*historyservice.GetWorkflowTimeSkippingResponse, error)
