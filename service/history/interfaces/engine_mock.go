...
func (m *MockEngine) GetWorkflowTimeSkipping(ctx context.Context, request *historyservice.GetWorkflowTimeSkippingRequest) (*historyservice.GetWorkflowTimeSkippingResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkflowTimeSkipping", ctx, request)
...
func (mr *MockEngineMockRecorder) GetWorkflowTimeSkipping(ctx, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWorkflowTimeSkipping", reflect.TypeOf((*MockEngine)(nil).GetWorkflowTimeSkipping), ctx, request)
}
