...
type FastForwardInfo struct {
	...
	// Virtual (time-skipping) time at which this fast-forward was created, i.e. the
	// mutable state's virtual clock when the user set the fast-forward. Recorded
	// directly from mutable state rather than derived from any history event, so it
	// is valid for executions that have no events (e.g. CHASM).
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// Wall-clock (real) time corresponding to create_time, i.e. virtual create_time
	// minus the accumulated skipped duration at creation. Like create_time, it is
	// recorded directly from mutable state and does not depend on history events.
	CreateTimeReal *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=create_time_real,json=createTimeReal,proto3" json:"create_time_real,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *FastForwardInfo) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *FastForwardInfo) GetCreateTimeReal() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTimeReal
	}
	return nil
}
...
const file_temporal_server_api_persistence_v1_executions_proto_rawDesc = "" +
	...
	" last_update_versioned_transition\x18\x05 \x01(\v27.temporal.server.api.persistence.v1.VersionedTransitionR\x1dlastUpdateVersionedTransitionJ\x04\b\x03\x10\x04R\x1ecurrent_elapsed_duration_bound\"\x9a\x02\n" +
	"\x0fFastForwardInfo\x12;\n" +
	"\vtarget_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"targetTime\x12\x1f\n" +
	"\vhas_reached\x18\x02 \x01(\bR\n" +
	"hasReached\x12&\n" +
	"\x0fsource_event_id\x18\x03 \x01(\x03R\rsourceEventId\x12;\n" +
	"\vcreate_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12D\n" +
	"\x10create_time_real\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x0ecreateTimeReal\"\xa8\x01\n" +
...
var file_temporal_server_api_persistence_v1_executions_proto_depIdxs = []int32{
	...
	47,  // 53: temporal.server.api.persistence.v1.FastForwardInfo.create_time:type_name -> google.protobuf.Timestamp
	47,  // 54: temporal.server.api.persistence.v1.FastForwardInfo.create_time_real:type_name -> google.protobuf.Timestamp
