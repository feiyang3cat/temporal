...
const file_temporal_server_api_persistence_v1_executions_proto_rawDesc = "" +
	...
	" last_update_versioned_transition\x18\x05 \x01(\v27.temporal.server.api.persistence.v1.VersionedTransitionR\x1dlastUpdateVersionedTransitionJ\x04\b\x03\x10\x04R\x1ecurrent_elapsed_duration_bound\"\x9c\x01\n" +
	"\x0fFastForwardInfo\x12;\n" +
	"\vtarget_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"targetTime\x12\x1f\n" +
	"\vhas_reached\x18\x02 \x01(\bR\n" +
	"hasReached\x12\x14\n" +
	"\x05stamp\x18\x04 \x01(\x05R\x05stampJ\x04\b\x03\x10\x04R\x0fsource_event_id\"\xa8\x01\n" +
