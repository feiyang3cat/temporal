...
// Marshal an object of type TimeSkippingDetail to the protobuf v3 wire format
func (val *TimeSkippingDetail) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type TimeSkippingDetail from the protobuf v3 wire format
func (val *TimeSkippingDetail) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *TimeSkippingDetail) Size() int {
	return proto.Size(val)
}

// Equal returns whether two TimeSkippingDetail values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *TimeSkippingDetail) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *TimeSkippingDetail
	switch t := that.(type) {
	case *TimeSkippingDetail:
		that1 = t
	case TimeSkippingDetail:
		that1 = &t
	default:
...
// Equal returns whether two WorkflowPauseInfo values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *WorkflowPauseInfo) Equal(that interface{}) bool {
	...
	var that1 *WorkflowPauseInfo
	switch t := that.(type) {
	case *WorkflowPauseInfo:
		that1 = t
	case WorkflowPauseInfo:
		that1 = &t
	default:
