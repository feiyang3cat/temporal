...
// Marshal an object of type TargetNamespace to the protobuf v3 wire format
func (val *TargetNamespace) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type TargetNamespace from the protobuf v3 wire format
func (val *TargetNamespace) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *TargetNamespace) Size() int {
	return proto.Size(val)
}

// Equal returns whether two TargetNamespace values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *TargetNamespace) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *TargetNamespace
	switch t := that.(type) {
