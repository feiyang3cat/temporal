...
type GetWorkflowTimeSkippingRequest struct {
	state         protoimpl.MessageState             `protogen:"open.v1"`
	NamespaceId   string                             `protobuf:"bytes,1,opt,name=namespace_id,json=namespaceId,proto3" json:"namespace_id,omitempty"`
	Request       *v1.GetWorkflowTimeSkippingRequest `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWorkflowTimeSkippingRequest) Reset() {
	*x = GetWorkflowTimeSkippingRequest{}
	mi := &file_temporal_server_api_historyservice_v1_request_response_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWorkflowTimeSkippingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWorkflowTimeSkippingRequest) ProtoMessage() {}

func (x *GetWorkflowTimeSkippingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_historyservice_v1_request_response_proto_msgTypes[56]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWorkflowTimeSkippingRequest.ProtoReflect.Descriptor instead.
func (*GetWorkflowTimeSkippingRequest) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_historyservice_v1_request_response_proto_rawDescGZIP(), []int{56}
}

func (x *GetWorkflowTimeSkippingRequest) GetNamespaceId() string {
	if x != nil {
		return x.NamespaceId
	}
	return ""
...
func (x *GetWorkflowTimeSkippingRequest) GetRequest() *v1.GetWorkflowTimeSkippingRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
type GetWorkflowTimeSkippingResponse struct {
	state         protoimpl.MessageState              `protogen:"open.v1"`
	Response      *v1.GetWorkflowTimeSkippingResponse `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWorkflowTimeSkippingResponse) Reset() {
	*x = GetWorkflowTimeSkippingResponse{}
	mi := &file_temporal_server_api_historyservice_v1_request_response_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWorkflowTimeSkippingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWorkflowTimeSkippingResponse) ProtoMessage() {}

func (x *GetWorkflowTimeSkippingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_api_historyservice_v1_request_response_proto_msgTypes[57]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWorkflowTimeSkippingResponse.ProtoReflect.Descriptor instead.
func (*GetWorkflowTimeSkippingResponse) Descriptor() ([]byte, []int) {
	return file_temporal_server_api_historyservice_v1_request_response_proto_rawDescGZIP(), []int{57}
}

func (x *GetWorkflowTimeSkippingResponse) GetResponse() *v1.GetWorkflowTimeSkippingResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
const file_temporal_server_api_historyservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x16workflow_extended_info\x18\b \x01(\v27.temporal.api.workflow.v1.WorkflowExecutionExtendedInfoR\x14workflowExtendedInfo\"\xcc\x01\n" +
	"\x1eGetWorkflowTimeSkippingRequest\x12!\n" +
	"\fnamespace_id\x18\x01 \x01(\tR\vnamespaceId\x12Y\n" +
	"\arequest\x18\x02 \x01(\v2?.temporal.api.workflowservice.v1.GetWorkflowTimeSkippingRequestR\arequest:,\x92\xc4\x03(*&request.workflow_execution.workflow_id\"\x7f\n" +
	"\x1fGetWorkflowTimeSkippingResponse\x12\\\n" +
	"\bresponse\x18\x01 \x01(\v2@.temporal.api.workflowservice.v1.GetWorkflowTimeSkippingResponseR\bresponse\"\xa9\x04\n" +
...
var file_temporal_server_api_historyservice_v1_request_response_proto_goTypes = []any{
	...
	(*GetWorkflowTimeSkippingRequest)(nil),                  // 56: temporal.server.api.historyservice.v1.GetWorkflowTimeSkippingRequest
	(*GetWorkflowTimeSkippingResponse)(nil),                 // 57: temporal.server.api.historyservice.v1.GetWorkflowTimeSkippingResponse
	...
	(*v1.GetWorkflowTimeSkippingRequest)(nil),             // 231: temporal.api.workflowservice.v1.GetWorkflowTimeSkippingRequest
	(*v1.GetWorkflowTimeSkippingResponse)(nil),            // 232: temporal.api.workflowservice.v1.GetWorkflowTimeSkippingResponse
...
var file_temporal_server_api_historyservice_v1_request_response_proto_depIdxs = []int32{
	...
	231, // 132: temporal.server.api.historyservice.v1.GetWorkflowTimeSkippingRequest.request:type_name -> temporal.api.workflowservice.v1.GetWorkflowTimeSkippingRequest
	232, // 133: temporal.server.api.historyservice.v1.GetWorkflowTimeSkippingResponse.response:type_name -> temporal.api.workflowservice.v1.GetWorkflowTimeSkippingResponse
	...
	66,  // 152: temporal.server.api.historyservice.v1.SyncActivitiesRequest.activities_info:type_name -> temporal.server.api.historyservice.v1.ActivitySyncInfo
	...
	98,  // 185: temporal.server.api.historyservice.v1.GetReplicationStatusResponse.shards:type_name -> temporal.server.api.historyservice.v1.ShardReplicationStatus
	...
	205, // 206: temporal.server.api.historyservice.v1.GetWorkflowExecutionHistoryResponse.history:type_name -> temporal.api.history.v1.History
	...
	274, // 242: temporal.server.api.historyservice.v1.SyncWorkflowStateResponse.versioned_transition_artifact:type_name -> temporal.server.api.replication.v1.VersionedTransitionArtifact
	275, // 243: temporal.server.api.historyservice.v1.UpdateActivityOptionsRequest.update_request:type_name -> temporal.api.workflowservice.v1.UpdateActivityOptionsRequest
	276, // 244: temporal.server.api.historyservice.v1.UpdateActivityOptionsResponse.activity_options:type_name -> temporal.api.activity.v1.ActivityOptions
	277, // 245: temporal.server.api.historyservice.v1.PauseActivityRequest.frontend_request:type_name -> temporal.api.workflowservice.v1.PauseActivityRequest
	278, // 246: temporal.server.api.historyservice.v1.UnpauseActivityRequest.frontend_request:type_name -> temporal.api.workflowservice.v1.UnpauseActivityRequest
	279, // 247: temporal.server.api.historyservice.v1.ResetActivityRequest.frontend_request:type_name -> temporal.api.workflowservice.v1.ResetActivityRequest
	280, // 248: temporal.server.api.historyservice.v1.UpdateWorkflowExecutionOptionsRequest.update_request:type_name -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest
	281, // 249: temporal.server.api.historyservice.v1.UpdateWorkflowExecutionOptionsResponse.workflow_execution_options:type_name -> temporal.api.workflow.v1.WorkflowExecutionOptions
	...
	282, // 251: temporal.server.api.historyservice.v1.PauseWorkflowExecutionRequest.pause_request:type_name -> temporal.api.workflowservice.v1.PauseWorkflowExecutionRequest
	283, // 252: temporal.server.api.historyservice.v1.UnpauseWorkflowExecutionRequest.unpause_request:type_name -> temporal.api.workflowservice.v1.UnpauseWorkflowExecutionRequest
	284, // 253: temporal.server.api.historyservice.v1.StartNexusOperationRequest.request:type_name -> temporal.api.nexus.v1.StartOperationRequest
	285, // 254: temporal.server.api.historyservice.v1.StartNexusOperationResponse.response:type_name -> temporal.api.nexus.v1.StartOperationResponse
	286, // 255: temporal.server.api.historyservice.v1.CancelNexusOperationRequest.request:type_name -> temporal.api.nexus.v1.CancelOperationRequest
	287, // 256: temporal.server.api.historyservice.v1.CancelNexusOperationResponse.response:type_name -> temporal.api.nexus.v1.CancelOperationResponse
	...
	107, // 258: temporal.server.api.historyservice.v1.ExecuteMultiOperationRequest.Operation.update_workflow:type_name -> temporal.server.api.historyservice.v1.UpdateWorkflowExecutionRequest
	...
	108, // 260: temporal.server.api.historyservice.v1.ExecuteMultiOperationResponse.Response.update_workflow:type_name -> temporal.server.api.historyservice.v1.UpdateWorkflowExecutionResponse
	...
	100, // 264: temporal.server.api.historyservice.v1.ShardReplicationStatus.RemoteClustersEntry.value:type_name -> temporal.server.api.historyservice.v1.ShardReplicationStatusPerCluster
	99,  // 265: temporal.server.api.historyservice.v1.ShardReplicationStatus.HandoverNamespacesEntry.value:type_name -> temporal.server.api.historyservice.v1.HandoverNamespaceInfo
	233, // 266: temporal.server.api.historyservice.v1.AddTasksRequest.Task.blob:type_name -> temporal.api.common.v1.DataBlob
